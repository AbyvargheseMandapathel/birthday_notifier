...
const MockStatCard = ({ value, label, sub, iconBg, icon }) => (
 <div className="bg-[#0d1220] rounded-2xl p-3 flex items-center gap-3 border border-zinc-800/60">
 <div className={`w-9 h-9 ${iconBg} rounded-xl flex items-center justify-center text-white flex-shrink-0`}>{icon}</div>
 <div>
 <p className="text-lg font-black text-white leading-none">{value}</p>
 <p className="text-[8px] text-zinc-400 font-bold uppercase tracking-wider mt-0.5">{label}</p>
 <p className="text-[7px] text-zinc-500">{sub}</p>
 </div>
 </div>
);
...
export default function Home() {
 ...
 <div className="w-9 h-9 sm:w-10 sm:h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg ">
 ...
 <Link href="/register" className="px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-indigo-600 text-white text-[12px] sm:text-[13px] font-bold hover:bg-indigo-500 transition-all shadow-lg ">Get Started Free</Link>
 </div>
 </nav>
 ...
 className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-zinc-100 dark:bg-zinc-800/60 border border-zinc-200 dark:border-zinc-700/50 text-[var(--foreground)] text-xs font-bold mb-8 sm:mb-10"
 >
 ...
 >
 <Link href="/register"
 className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-indigo-600 text-white font-bold text-base hover:bg-indigo-500 transition-all shadow-2xl flex items-center justify-center gap-3"
 >
 Get Started Free <ArrowRight size={18} />
 </Link>
 <button className="w-full sm:w-auto flex items-center justify-center gap-3 px-7 py-4 bg-transparent border border-zinc-200 dark:border-zinc-700 rounded-2xl text-[var(--foreground)] font-bold hover:bg-white/5 transition-all group">
 <div className="w-9 h-9 bg-zinc-100 dark:bg-zinc-800 rounded-full flex items-center justify-center text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform">
 ...
 <div className="relative bg-[#060a14] rounded-[2rem] border border-zinc-800/60 shadow-[0_60px_140px_-30px_rgba(0,0,0,0.7)] overflow-hidden">
 <div className="flex">
 {/* ─ Sidebar ─ */}
 <div className="w-44 bg-[#080d1a] border-r border-zinc-800/50 p-5 flex flex-col gap-6 flex-shrink-0">
 ...
 <p className="text-[7px] text-zinc-400 mb-3">Find the perfect gift and never miss a celebration.</p>
 ...
 <p className="text-[8px] text-zinc-500">Here&apos;s what&apos;s happening with your important people.</p>
 </div>
 ...
 <div className="bg-[#0d1220] rounded-2xl p-4 border border-zinc-800/50">
 ...
 <p className="text-[7px] text-zinc-500">{p.date} · <span className="text-indigo-400">{p.days}</span></p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 <span className="text-[8px] text-zinc-500 font-medium">{p.turns}</span>
 <div className="w-6 h-6 bg-indigo-600/20 rounded-lg flex items-center justify-center text-indigo-400"><Gift size={10} /></div>
 </div>
 </div>
 ))}
 <div className="mt-3 py-2.5 border-2 border-dashed border-zinc-800 rounded-xl text-center text-[8px] font-bold text-zinc-600">
 + Add Birthday
 </div>
 </div>
 </div>
 ...
 <div className="absolute -top-12 -left-20 bg-white dark:bg-zinc-800 rounded-2xl px-4 py-3 shadow-2xl border border-zinc-100 dark:border-zinc-700 -rotate-6">
 <p className="text-[10px] font-black text-zinc-900 dark:text-white italic">Happy Birthday! 🎉</p>
 </div>
 </div>
 </div>
 ...
 {/* ──────────── FOOTER ──────────── */}
 <footer className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 border-t border-zinc-100 dark:border-zinc-800/50 flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-8 relative z-10 text-[var(--text-muted)]">
 <div className="flex items-center gap-3">
