  ...
  return (
    <>
      <div className="text-center mb-10">
        ...
        <p className="text-slate-500 mt-2 text-sm">Enter your new secure password</p>
      </div>
          ...
          {token && (
            <>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    type="password" 
                    required 
                    className="input-field pl-12 bg-slate-50/50 border-slate-100 focus:bg-white"
                    placeholder="••••••••"
                    value={password}
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="btn-primary w-full flex items-center justify-center gap-2 mt-4 py-4 shadow-xl shadow-indigo-100"
              >
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="bg-white w-full max-w-md p-10 rounded-[3rem] shadow-xl shadow-slate-200/50 relative z-10 border border-white"
      >
        <Suspense fallback={
