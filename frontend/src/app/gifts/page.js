  ...
  return (
    <div className="flex min-h-screen bg-slate-50/50">
      ...
      <main className="flex-1 p-8 flex flex-col items-center justify-center relative overflow-hidden">
        ...
        >
            <div className="w-24 h-24 bg-white rounded-[2rem] flex items-center justify-center shadow-2xl shadow-indigo-200/50 mx-auto mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <div className="flex items-center gap-2 px-6 py-3 bg-white rounded-2xl border border-slate-100 shadow-sm text-slate-600 font-bold text-sm">
