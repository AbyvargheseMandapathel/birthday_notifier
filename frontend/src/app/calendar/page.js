...
export default function CalendarPage() {
 ...
 <p className="text-zinc-500 text-sm mt-1">View all birthdays and special days at a glance.</p>
 </div>
 ...
 <button className="p-1.5 hover:bg-zinc-50 rounded-lg text-zinc-400"><ChevronLeft size={18} /></button>
 <button className="p-1.5 hover:bg-zinc-50 rounded-lg text-zinc-400"><ChevronRight size={18} /></button>
 </div>
 <h2 className="text-xl font-bold text-zinc-900 ml-4">May 2024</h2>
 </div>
 ...
 <button className="px-4 py-1.5 text-zinc-400 rounded-lg text-xs font-bold hover:bg-zinc-50 transition-all">Week</button>
 <button className="px-4 py-1.5 text-zinc-400 rounded-lg text-xs font-bold hover:bg-zinc-50 transition-all">List</button>
 </div>
 ...
 {/* Calendar Grid */}
 <div className="col-span-3 bg-white rounded-[2.5rem] border border-zinc-100 shadow-sm overflow-hidden flex flex-col">
 ...
 <div className="flex-1 grid grid-cols-7 grid-rows-5 divide-x divide-y divide-zinc-50">
 ...
 return (
 <div key={i} className={`p-4 min-h-[120px] transition-colors hover:bg-zinc-50/50 relative ${day < 1 || day > 31 ? 'opacity-20 bg-zinc-50/20' : ''}`}>
 <span className={`text-xs font-bold ${isToday ? 'bg-indigo-600 text-white w-6 h-6 flex items-center justify-center rounded-full' : 'text-zinc-400'}`}>
 {day > 0 && day <= 31 ? day : ''}
 </span>
 ...
 <h3 className="font-bold text-zinc-900">Upcoming Birthdays</h3>
 ...
 <div>
 <h4 className="text-sm font-bold text-zinc-900">{bday.friend_name}</h4>
 <p className="text-[10px] text-zinc-400 font-medium">May {bday.day} • In {bday.days_until} days</p>
 </div>
 </div>
 <button className="p-2 bg-zinc-50 rounded-lg text-zinc-300 hover:text-indigo-600 hover:bg-indigo-50 transition-all opacity-0 group-hover:opacity-100">
 <Gift size={16} />
 </button>
 </div>
 ))}
 ...
 <div className="bg-zinc-50 border border-zinc-100 rounded-[2rem] p-8 flex flex-col items-center text-center">
 <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-6">
 <CalendarIcon size={32} className="text-indigo-600" />
 </div>
 <h3 className="font-bold text-zinc-900 mb-2">Sync your calendar</h3>
 ...
 <div className="p-4 bg-white rounded-[2rem] border border-zinc-100">
 <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-4 px-2">Calendar Legend</h4>
