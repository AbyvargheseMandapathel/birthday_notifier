...
export default function RegisterPage() {
 ...
 className="bg-[#0b0f1a] w-full max-w-2xl p-10 sm:p-14 rounded-[3.5rem] shadow-[0_80px_120px_-20px_rgba(0,0,0,0.6)] relative z-10 border border-zinc-800/50"
 >
 ...
 <p className="text-zinc-400 mt-2 text-sm font-medium">Join BirthdayRemainder and never forget a date</p>
 </div>
 ...
 <div className="relative group">
 <User className="absolute left-5 top-5 text-zinc-500 group-focus-within:text-indigo-400 transition-colors" size={18} />
 <input 
 type="text" 
 required 
 className="w-full bg-[#02040a] text-white rounded-2xl pl-14 pr-6 py-5 text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 transition-all border border-zinc-800/80 focus:border-indigo-500 placeholder:text-zinc-700"
 ...
 <div className="relative group">
 <Globe className="absolute left-5 top-5 text-zinc-500 group-focus-within:text-indigo-400 transition-colors" size={18} />
 <select 
 className="w-full bg-[#02040a] text-white rounded-2xl pl-14 pr-10 py-5 text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 transition-all border border-zinc-800/80 focus:border-indigo-500 appearance-none text-zinc-300"
 value={timezone}
 ...
 type="submit" 
 disabled={loading}
 className="w-full md:col-span-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-5 rounded-2xl shadow-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-70 mt-2 group"
 >
