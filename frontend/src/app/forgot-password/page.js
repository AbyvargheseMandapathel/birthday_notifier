...
export default function ForgotPasswordPage() {
 ...
 <div className="w-16 h-16 bg-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl text-white">
 <Cake size={32} />
 </div>
 <h1 className="text-4xl font-extrabold text-white tracking-tight">Forgot Password</h1>
 <p className="text-zinc-400 mt-2 text-sm font-medium">We'll send you instructions to reset it</p>
 </div>
 ...
 <Link href="/login" className="flex items-center justify-center gap-2 text-zinc-400 hover:text-white transition-colors text-sm font-bold group">
 ...
 <Send size={18} className="group-hover:tranzinc-x-1 group-hover:-tranzinc-y-0.5 transition-transform" />
 </>
 )}
 </button>

 <Link href="/login" className="flex items-center justify-center gap-2 text-zinc-500 hover:text-white transition-colors text-sm font-bold group pt-2">
 <ArrowLeft size={18} className="group-hover:-tranzinc-x-1 transition-transform" />
 Back to Login
 </Link>
 </motion.form>
